        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Make an Offer</h2>
                    <h3 class="section-subheading text-muted">Choose the items you wish to offer to ${owner.userName} for the ${item.itemName}.</h3>
                </div>
            </div>
            <div class="row">
            <c:forEach items="${items}" var="items" varStatus="loop">
                <div class="col-md-4 col-sm-6 portfolio-item">
                    <a href="#portfolioModal${loop.index}" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="bootstrap/img/portfolio/${items.itemName}.png" class="img-responsive" alt="">
                    </a>
                    <div class="portfolio-caption">
                    <input type="checkbox" name="offeredItems" id="${items.itemId}" value="${items.itemId}">
					<label for="offeredItems">${items.itemName}</label>
